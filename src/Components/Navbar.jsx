  ...
  return (
    <div className="flex justify-between bg-transparent p-7 items-center w-full sm:p-6 absolute z-[100]">
      ...
      {user?.email ? (
        ...
        <button onClick={handleLogout} className="hover:bg-red-700 border-2 border-gray-700 rounded-md flex items-center px-4 py-2 md:px-2 md:py-1 md:text-md bg-red-600 text-lg font-semibold sm:text-sm hover:-translate-y-1 hover:scale-105 transition ease-in-out delay-75 duration-300">
          Logout
        </button>   
      </div>
      ): <div className="ss:flex-col flex gap-1 bg-transparent">
